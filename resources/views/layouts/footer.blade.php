    ...
    <div class="container">
        ...
        {{-- <div class="row justify-content-center mb-5 xs-mb-20px">
            ...
            <div class="col-md-12 col-sm-10 text-center">
                ...
                <h4 class="alt-font text-dark-gray fw-500 ls-minus-1px">Looking for business opportunity? <a
                        href="/cdn-cgi/l/email-protection#3c55525a537c4553494e5853515d5552125f5351"
                        class="text-base-color fw-500 text-decoration-line-bottom-medium">Send message</a></h4>
        ...
        <div class="row justify-content-center">
            ...
            <div
                ...
                <a href='http://www.freevisitorcounters.com'>more on freevisitorcounters.com</a> <script type='text/javascript' src='https://www.freevisitorcounters.com/auth.php?id=5d3f044c444bba1ee1272334a80cbacee0ca9766'></script>
<script type="text/javascript" src="https://www.freevisitorcounters.com/en/home/counter/1391873/t/5"></script>
                {{-- <div class="d-inline-block w-100 newsletter-style-02 position-relative">
                    ...
                    <form action="email-templates/subscribe-newsletter.php" method="post"
                        ...
                        <input class="bg-white border-color-white w-100 form-control required box-shadow-double-large"
                            type="email" name="email" placeholder="Enter your email">

                        <input type="hidden" name="redirect" value="">

                        <button class="btn submit" aria-label="submit"><i
                                class="icon feather icon-feather-mail fs-22 text-base-color"></i></button>
